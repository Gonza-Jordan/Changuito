...
//        // Preparacion
//        List<Producto> productosMock = new ArrayList<>();
//        productosMock.add(new Producto("Coca Cola", "123", Categoria.Bebidas, Subcategoria.Gaseosas, ""));
//        productosMock.add(new Producto("Sprite",  "456", Categoria.Bebidas, Subcategoria.Gaseosas, ""));
//        productosMock.add(new Producto("Fanta", "789", Categoria.Bebidas, Subcategoria.Gaseosas, ""));
//
