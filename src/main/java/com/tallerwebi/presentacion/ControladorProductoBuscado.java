...
//
//            // Eliminar duplicados
//            Set<Producto> productosFiltradosSet = new HashSet<>(productosFiltrados);
//            List<Producto> productosFiltradosSinDuplicados = new ArrayList<>(productosFiltradosSet);
//            model.put("productos", productosFiltradosSinDuplicados);
//
//            if (productosFiltradosSinDuplicados.isEmpty()) {
